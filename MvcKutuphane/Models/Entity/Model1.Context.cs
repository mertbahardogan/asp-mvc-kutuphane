...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> CokOkunanKitap()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("CokOkunanKitap");
        }
        ...
        public virtual ObjectResult<string> BugünVerilenKitap()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("BugünVerilenKitap");
        }
    
        public virtual ObjectResult<Nullable<int>> BugunVerilenKitapSayisi()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("BugunVerilenKitapSayisi");
        }
    
        public virtual ObjectResult<Nullable<decimal>> GunlukKazanilan()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("GunlukKazanilan");
        }
    }
}
